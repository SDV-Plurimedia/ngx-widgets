...
export class LoaderService {
  ...
  private getMessage(state: number = 0): string {
    ...
    if (state > 0) {
      str += `<br/>
        <div class="progress">
          <div class="progress-bar progress-bar-info progress-bar-striped" role="progressbar" aria-valuenow="${state}"
          aria-valuemin="0" aria-valuemax="100" style="width: ${state}0%">
