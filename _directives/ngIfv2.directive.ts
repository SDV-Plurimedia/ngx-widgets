 ...
 *
 * {@example common/ngIf/ts/module.ts region='NgIf2Else'}
 *
 ...
 * @stable
 */
@Directive({selector: '[ngIfv2]'})
export class NgIfv2Directive {
  ...
  @Input()
  set ngIfv2(condition: any) {
    this._context.$implicit = condition;
    this._updateView();
  }

  @Input()
  set ngIfv2Then(templateRef: TemplateRef<NgIfContext>) {
    this._thenTemplateRef = templateRef;
  ...
  @Input()
  set ngIfv2Else(templateRef: TemplateRef<NgIfContext>) {
